...
public class SecurityConfig {
	...
	public WebSecurityCustomizer webSecurityCustomizer() {
		return (web) -> web.ignoring().requestMatchers("/login","/actividades","/noticias","/register","/historia","/autoridades","/productosUpdate","/finalizarCarrito","/productos","/ventas","/misPedidos","/productos/:id","productos/:id","productos/","/productos/*","/productos/**","productos/*","productos/**","/ws","ws","admin/register");
	}
